...
for (var i = 0; i < actionsImages.length; i++) {
  actionsImages[i].addEventListener("click", function (e) {
    ...
    var actionsMenus = document.getElementsByClassName('actionsMenu'); //On s'assure qu'aucun formulaire de suppression n'est ouvert
...
for (var i = 0; i < deleteLinks.length; i++) {
  deleteLinks[i].addEventListener("click", function (e) {
    var elementName = e.target.id;
    var elementId = elementName.split('_');
    var deleteForm = document.getElementById('deleteForm' + elementId[1]); //Si le formulaire de suppression est masqué...
...
for (var i = 0; i < cancelButton.length; i++) {
  ...
  cancelButton[i].addEventListener("click", function () {
    console.log('Le bouton fonctionne!'); //On récupère tous les formulaires de suppression
...
__webpack_require__(/*! C:\laragon\www\mynotes\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\laragon\www\mynotes\resources\sass\app.scss */"./resources/sass/app.scss");
